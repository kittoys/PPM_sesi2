...
const Coffee =() =>{
    return(
        <View style={{backgroundColor:"black",}}>
            <View style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 40, marginLeft: 30, marginRight: 30}}>
                <View style={{flexDirection: 'column'}}>
                    <Text style={styles.Lokasi}>
                        Location
                    </Text>
                    <Text style={{width:150, height:18, fontFamily:"sora", fontWeight:"600", fontSize:14, lineHeight:17.64, color:"#DDDDDD"}}>
                        Bilzen, Tanjungbalai
                    </Text>
                </View>
                <View>
                    <Image source={rizky} style={styles.Avatar}></Image>
                </View>                
            </View>
